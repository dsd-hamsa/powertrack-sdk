#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_register_offsets()
Usage: python3 examples/get_register_offsets.py --hardware-id H12345 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get register offsets for hardware",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_register_offsets.py --hardware-id H12345 --mock
  python3 examples/get_register_offsets.py --hardware-id H12345 --output offsets.json
        """
    )
    ...
    if args.verbose:
        print(f"Calling get_register_offsets(hardware_id='{args.hardware_id}')", file=sys.stderr)

    try:
        result = client.get_register_offsets(args.hardware_id)
