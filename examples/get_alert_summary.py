#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_alert_summary()
Usage: python3 examples/get_alert_summary.py --customer-id C8458 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get alert summary for customer or site",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_alert_summary.py --customer-id C8458 --mock
  python3 examples/get_alert_summary.py --site-id S60308 --mock
  python3 examples/get_alert_summary.py --customer-id C8458 --output summary.json
        """
    )
    ...
    if args.verbose:
        print(f"Calling get_alert_summary(customer_id='{args.customer_id}', site_id='{args.site_id}')", file=sys.stderr)

    try:
        result = client.get_alert_summary(customer_id=args.customer_id, site_id=args.site_id)
    ...
    output = {
        ...
        "args": {"customer_id": args.customer_id, "site_id": args.site_id},
