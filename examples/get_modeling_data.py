#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_modeling_data()
Usage: python3 examples/get_modeling_data.py --site-id S60308 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get modeling data for site",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_modeling_data.py --site-id S60308 --mock
  python3 examples/get_modeling_data.py --site-id S60308 --output modeling.json
        """
    )
    ...
    if args.verbose:
        print(f"Calling get_modeling_data(site_id='{args.site_id}')", file=sys.stderr)

    try:
        result = client.get_modeling_data(args.site_id)
