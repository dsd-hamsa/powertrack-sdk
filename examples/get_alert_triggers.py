#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_alert_triggers()
Usage: python3 examples/get_alert_triggers.py --hardware-id H12345 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get alert triggers for hardware",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_alert_triggers.py --hardware-id H12345 --mock
  python3 examples/get_alert_triggers.py --hardware-id H12345 --output triggers.json
        """
    )
    ...
    if args.verbose:
        print(f"Calling get_alert_triggers(hardware_key='{args.hardware_id}')", file=sys.stderr)

    try:
        result = client.get_alert_triggers(args.hardware_id)
