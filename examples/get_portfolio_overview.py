#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_portfolio_overview()
Usage: python3 examples/get_portfolio_overview.py --customer-id C8458 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get portfolio overview for a customer",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_portfolio_overview.py --customer-id C8458 --mock
  python3 examples/get_portfolio_overview.py --customer-id C8458 --output overview.json
        """
    )
    parser.add_argument("--customer-id", required=True, help="Customer ID (e.g., C8458)")
    ...
    if args.verbose:
        print(f"Calling get_portfolio_overview(customer_id='{args.customer_id}')", file=sys.stderr)

    try:
        result = client.get_portfolio_overview(args.customer_id)
