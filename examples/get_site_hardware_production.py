#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_site_hardware_production()
Usage: python3 examples/get_site_hardware_production.py --site-id S60308 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get hardware production data for a site",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_site_hardware_production.py --site-id S60308 --mock
  python3 examples/get_site_hardware_production.py --site-id S60308 --output production.json
        """
    )
    ...
    if args.verbose:
        print(f"Calling get_site_hardware_production(site_id='{args.site_id}')", file=sys.stderr)

    try:
        result = client.get_site_hardware_production(args.site_id)
    ...
    output = {
        "method": "get_site_hardware_production",
