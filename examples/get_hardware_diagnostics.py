#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_hardware_diagnostics()
Usage: python3 examples/get_hardware_diagnostics.py --hardware-id H12345 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get hardware diagnostic information",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_hardware_diagnostics.py --hardware-id H12345 --mock
  python3 examples/get_hardware_diagnostics.py --hardware-id H12345 --output diagnostics.json
        """
    )
    ...
    if args.verbose:
        print(f"Calling get_hardware_diagnostics(hardware_id='{args.hardware_id}')", file=sys.stderr)

    try:
        result = client.get_hardware_diagnostics(args.hardware_id)
