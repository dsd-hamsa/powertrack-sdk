#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_site_overview()
Usage: python3 examples/get_site_overview.py --site-id S60308 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get site overview for a site",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_site_overview.py --site-id S60308 --mock
  python3 examples/get_site_overview.py --site-id S60308 --output overview.json
        """
    )
    ...
    if args.verbose:
        print(f"Calling get_site_overview(site_id='{args.site_id}')", file=sys.stderr)

    try:
        result = client.get_site_overview(args.site_id)
