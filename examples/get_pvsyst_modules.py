#!/usr/bin/env python3
"""
Example script for PowerTrackClient.get_pvsyst_modules()
Usage: python3 examples/get_pvsyst_modules.py --hardware-id H12345 [--mock]
"""
...
def main(argv: Optional[list[str]] = None) -> None:
    parser = argparse.ArgumentParser(
        description="Example: Get PVSyst module configurations",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 examples/get_pvsyst_modules.py --hardware-id H12345 --mock
  python3 examples/get_pvsyst_modules.py --site-id S60308 --mock
  python3 examples/get_pvsyst_modules.py --hardware-id H12345 --output modules.json
        """
    )
    parser.add_argument("--hardware-id", help="Hardware ID")
    parser.add_argument("--site-id", help="Site ID (alternative to hardware-id)")
    ...
    if not args.hardware_id and not args.site_id:
        parser.error("Either --hardware-id or --site-id must be provided")
